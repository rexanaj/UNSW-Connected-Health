...
"""
Program to update the student interpretation CSV file and append the model results
"""
with open('ECG_Interpretation_All.csv', 'r', encoding="utf-8-sig") as csvinput:
